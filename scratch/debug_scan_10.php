...
$scan = Scan::find(10) ?: Scan::latest()->first();
...
echo "Report file exists? " . (File::exists($reportPath) ? 'YES' : 'NO') . "\n";
if (File::exists($reportPath)) {
    echo "Report file size: " . filesize($reportPath) . " bytes\n";
}
